...
const es: FeedbackCopy = {
  ...
  qRecommend: "¿Recomendarías Anclora GuestHub? (0–10)",
  payYes: "Sí",
  payMaybe: "Quizá",
  payNo: "No por ahora",
...
const en: FeedbackCopy = {
  ...
  qRecommend: "Would you recommend Anclora GuestHub? (0–10)",
  payYes: "Yes",
  payMaybe: "Maybe",
  payNo: "Not yet",
...
const de: FeedbackCopy = {
  ...
  qRecommend: "Wuerdest du Anclora GuestHub weiterempfehlen? (0–10)",
  payYes: "Ja",
  payMaybe: "Vielleicht",
  payNo: "Noch nicht",
...
const ca: FeedbackCopy = {
  ...
  qRecommend: "Recomanaries Anclora GuestHub? (0–10)",
  payYes: "Sí",
  payMaybe: "Potser",
  payNo: "Encara no",
...
const fr: FeedbackCopy = {
  ...
  qRecommend: "Recommanderiez-vous Anclora GuestHub ? (0–10)",
  payYes: "Oui",
  payMaybe: "Peut-être",
  payNo: "Pas encore",
...
const it: FeedbackCopy = {
  ...
  qRecommend: "Consiglieresti Anclora GuestHub? (0–10)",
  payYes: "Sì",
  payMaybe: "Forse",
  payNo: "Non ancora",
...
const pt: FeedbackCopy = {
  ...
  qRecommend: "Recomendarias o Anclora GuestHub? (0–10)",
  payYes: "Sim",
  payMaybe: "Talvez",
  payNo: "Ainda não",
