# Smoke Tests E2E - Anclora GuestHub Pilot Candidate
...
## 2. anclora-nexus
Para probar la creación y revisión de tareas de GuestHub de manera directa en Supabase (Dry Run por defecto):
...
node scripts/smoke-guesthub-pilot-validation.mjs
\`\`\`
