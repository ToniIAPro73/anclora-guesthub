...
Declaración de adopción AOS para `anclora-guesthub`.

## Metadatos

- Repository Name: anclora-guesthub
...
`anclora-guesthub` forma parte del ecosistema Anclora como aplicación operativa Next.js.
